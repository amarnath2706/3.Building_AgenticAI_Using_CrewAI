...
def create_research_agent():
    ...
    #lm = ChatOpenAI(model="gpt-3.5-turbo")
    ...
    return Agent(
        ...
        verbose=True,
        allow_delegation=False, #here i have one agent so i make allow_delegation = false
        tools=[search_tool],
        llm=llm,
    )
...
#Create crew - combine agent and task
